  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center bg-[#F5F1E8] px-4 pt-20">
      <div className="text-center max-w-4xl">
        <p className="uppercase tracking-[0.3em] text-sm mb-8">Event Coordinator Portfolio</p>
        ...
        <p className="text-sm text-neutral-600 max-w-2xl mx-auto leading-relaxed">
          Planning and delivering 20-30 events a month for Melbourne&apos;s student community, from 200-person welcome parties to campus-wide Orientation Week
        </p>
      </div>
    </section>
  );
